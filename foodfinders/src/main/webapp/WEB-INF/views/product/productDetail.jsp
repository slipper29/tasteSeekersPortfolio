...
<body>
        	...
        	<div class="main1">
        		<div class="main_in">
	        		...
	        		<div class="product_content">
	        			<input type="hidden" class="pno" value="${pdetail.pno}">
	        			<h2 class="ptitle">${pdetail.pname}</h2>
	        			<div class="pprice">
	        				<p class="ptxt">${pdetail.pprice}<span>원</span></p>
	        			</div>
	        			<div class="pexplanation">
	        				<p>상품설명</p>
	        				<p class="ptxt">${pdetail.pcontent}</p>
	        			</div>
	        			<div class="pcategory">
	        				<p>상품 카테고리</p>
	        				<p class="ptxt">${pdetail.pcategory}</p>
	        			</div>
	        			<div class="pcount">
	        				<p>구매수량</p>
		        			<div class="pcount_box">
		        				<span class="minus">-</span>
		        				<form action="/product/shopping" id="shoppingForm" method="post">
		        					<input type="text" id="pcount" name="pcount" value="1">
		        					<input type="hidden" name="pno" value="${pdetail.pno}">
		        					<input type="hidden" name="pname" value="${pdetail.pname}">
		        					<input type="hidden" name="pprice" value="${pdetail.pprice}">
		        					<input type="hidden" name="id" id="userId" value="${session.id}">
	        			...
	        			<div class="ptotal">
	        				<p>총 상품금액</p>
	        				<p class="ptxt">9000<span>원</span></p>
	        			</div>
	        			<button class="pbtn">장바구니담기</button>
	        		</div>
        		</div><!-- main_in -->
        	</div> <!-- main1 -->
        </div> <!-- #container -->
    ...
    <!-- 파일 첨부 관련 JS -->
    <script src="../resources/js/attachDetail.js"></script>

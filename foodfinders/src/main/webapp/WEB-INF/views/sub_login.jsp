...
<head>
    ...
    <link rel="stylesheet" href="../../resources/css/sub_login.css">
</head>
<body>
    <div id="wrap">
        <div class="content">
            ...
            <div class="main_in">
                ...
                <div class="log">
                    <div class="log_top">
                        <div class="log_title">
                            <h1>로그인</h1>
                            <p>로그인을 하시면 더 많은 혜택을 누릴실 수 있습니다.</p>
                        </div>
                        <div class="login">
                            <form action="sub_login" method="post">
                                <fieldset>
                                    ...
                                    <button class="log_btn1">로그인</button>
                                </fieldset>
                            </form>
                        </div>
                        <div class="log_util">
                            ...
                            <div class="util_r">
                                <p class="on"><a href="sub_member">회원가입</a></p>
                                <p><a href="">아이디 찾기</a></p>
                        ...
                        <div class="log_sns">
                            <p class="n_log">
                                <a href="#"><img src="../../resources/img/naver_login.png" alt="네이버 로그인"></a>
                            </p>
                            <p class="k_log">
                                <a href="#"><img src="../../resources/img/kakao_login.png" alt="카카오 로그인"></a>
                            </p>
                        </div>
                    </div> <!--.log_top-->
                    <div class="log_title">
                    ...
                    <div class="login">
                        <form action="">
                            <fieldset>
                                ...
                                <input type="password" placeholder="주문번호를 입력하세요.">
                                <button class="log_btn2">로그인</button>
                            </fieldset>
                        </form>
                    </div>
                    <p class="alert">※ 주문번호와 비밀번호를 잊으신 경우, 고객센터로 문의하여 주시기 바랍니다.</p>
                </div> <!--.login-->
            </div> <!--.main_in-->
        </div> <!--#container-->
    ...
    <script src="../../resources/js/sub_login.js"></script>
</body>
</html>